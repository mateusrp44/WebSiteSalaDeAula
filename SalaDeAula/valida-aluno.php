...
<html>
    ...
    <body>
        ...
        $nome_aluno = $crud->limpaTexto($_POST['nome_aluno']);
        $data_nascimento = $crud->limpaTexto($_POST['data_nascimento']);
        $necessidade_auxilio = $crud->limpaTexto($_POST['necessidade_auxilio']);

        $msg = $validacoes->verifica_vazio($_POST, array('nome_aluno', 'data_nascimento'));
        ...
        if ($msg != null) {
            ...
            if (isset($_POST['salvar'])) {
                ...
                $insert = $crud->executarSql("INSERT INTO aluno(id, nome_aluno, necessidade_auxilio, data_nascimento) VALUES ('$id', '$nome_aluno', '$necessidade_auxilio', '$data_nascimento')");
                if ($insert) {
                ...
                $update = $crud->executarSql("UPDATE aluno SET nome_aluno='$nome_aluno', necessidade_auxilio='$necessidade_auxilio', data_nascimento='$data_nascimento' WHERE id=$id");
