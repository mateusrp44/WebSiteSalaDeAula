    ...
    class Crud extends Database
    {
          ...
          $query = Query que deverá ser executada no SGBD*/
        {
            ...
            if ($result == false)
            {
                ...
                echo $validacoes->botao('Voltar para o início', 'danger', 'menu.php', 'reply');
                return false;
            }
            else return true;
        }
          ...
          $tabela = Nome da tabela a ser removida*/
        {
            ...
            if ($result == false)
            {
                echo $validacoes->mensagem('Ops... Ocorreu um erro!', 'Não foi possível apagar o registro <strong> id ' . $id . ' </strong> da tabela <strong>' . $tabela . '</strong>', 'danger');
                echo $validacoes->botao('Voltar para o início', 'danger', 'menu.php', 'reply');
                return false;
            }
            else return true;
